...
def simplified_MD5_8bit(x1):
    print('While our input is ', x1, ' , we still get some difficulty 1 values of sorts')
    print()
    x2 = ord(x1)
...
d1 = target_qubit_counts
d1 = dict((k, v) for k, v in d1.items() if v >= 40)
print('Difficulty _1 values -- target qubits ;',d1)
...
d = all_qubit_counts
d = dict((k, v) for k, v in d.items() if v >= 40)
print('Difficulty _1 values -- all qubits ;',d)
print()
